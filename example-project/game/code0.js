...
gdjs.MainCode.GDBackgroundForScoreTextObjects1= [];
gdjs.MainCode.GDBackgroundForScoreTextObjects2= [];
gdjs.MainCode.GDBackgroundForScoreTextObjects3= [];
...
gdjs.MainCode.asyncCallback9771140 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.MainCode.asyncCallback9771140(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9770820);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9771940);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.MainCode.GDBallObjects1 */
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9774436);
}
}
if (isConditionTrue_0) {
...
gdjs.MainCode.GDBackgroundForScoreTextObjects1.length = 0;
gdjs.MainCode.GDBackgroundForScoreTextObjects2.length = 0;
gdjs.MainCode.GDBackgroundForScoreTextObjects3.length = 0;
